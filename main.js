...
async function handleMessage(msg) {
    ...
    if (
        ...
        msg.reply("By continuing to use this bot, you agree to release the creator, owners, all maintainers of the bot, and the " + process.settings.coin.symbol + " Team from any legal liability. Type in any command to begin using " + process.settings.discord.user);
